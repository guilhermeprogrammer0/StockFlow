                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="{{$usuario->id == Auth::user()->id ? 'bg-zinc-300': ''}}">@can('acao_admin',$usuario)<a href="{{route('editar_usuario',['id'=>Crypt::encrypt($usuario->id)])}}"><i class="fa-solid fa-pen-to-square text-orange-500 m-1 cursor:pointer"></i></a> @can('nao_excluir',$usuario)<a href="{{route('excluir_usuario',['id'=>Crypt::encrypt($usuario->id)])}}"><i class="fa-solid fa-trash text-red-700 cursor:pointer"></i></a> @endcan @endcan</td>
                        </tr>
                    </tbody>
                    @endforeach
                </table>
