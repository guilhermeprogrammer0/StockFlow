  ...
  <main class="main-container !h-180">
    ...
    <x-area-component >
      <div class="container bg-white rounded-md mt-2">
        ...
        <h1 class="escrito-entrar text-black text-center mt-50">Edição de clientes</h1>
        <form action="{{route('editar_cliente_submit')}}" method="POST" novalidate>
          ...
          <div class="mb-3">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="name" name="nome" value="{{old('nome',$cliente->nome)}}">
              @error('nome')
